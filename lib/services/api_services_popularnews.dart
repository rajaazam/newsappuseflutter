...
class ApiService {
 ...
 final res  = await http.get(Uri.parse('https://newsapi.org/v2/everything?q=apple&from=2021-09-30&to=2021-09-30&sortBy=popularity&apiKey=a80aad8a17dc46089a176be9c73e5724'));
     print(res);
